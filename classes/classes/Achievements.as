package classes {
	...
	public class Achievements extends BaseContent {
		...
		private function addAchievement(title:String, achievement:*, descLocked:String, descUnlocked:String = "", isShadow:Boolean = false):void {
			if (descUnlocked == "") descUnlocked = descLocked; //if not specified, default to the locked description
			...
			else stringToPut += "<font color=\"#800000\">Locked</font> - " + descLocked;
			if (isShadow) //Shadow flair? Add that
		...
		private function titleAchievementSection(title:String):void { outputText("\n<b><u>" + title + "</u></b>\n"); }
		...
		public function achievementsScreen():void {
			...
			titleAchievementSection("Storyline");
			...
			addAchievement("Oh my god!", kACHIEVEMENTS.LEVEL_OH_MY_GOD, "Get to level 75.");
			...
			addAchievement("Bloodrain", kACHIEVEMENTS.COMBAT_BLOOD_RAIN, "Deal a total of 100,000 damage.");
			...
			titleAchievementSection("Crusher");
			addAchievement("Tentacle Beast Slayer", kACHIEVEMENTS.GENERAL_TENTACLE_BEAST_SLAYER, "Slay your first Tentacle Beast.");
			addAchievement("Dragon Slayer", kACHIEVEMENTS.GENERAL_DRAGON_SLAYER, "Eat Ember or beat Kiha once time.");
			...
			titleAchievementSection("Transformations");
			...
			addAchievement("Bald Hero", kACHIEVEMENTS.GENERAL_BALD_HERO, "Become a bald.");
			...
			titleAchievementSection("Camp Progress");
			...
			titleAchievementSection("Relationships");
			...
			titleAchievementSection("Records");
			...
			addAchievement("Unimaginable Stats", kACHIEVEMENTS.GENERAL_STATS_150, "Have at least 150 of each stat. (Libido, sensitivity, corruption optional)");
			addAchievement("Supernatural Stats", kACHIEVEMENTS.GENERAL_STATS_200, "Have at least 200 of each stat. (Libido, sensitivity, corruption optional)");
			...
			addAchievement("Super-faper", kACHIEVEMENTS.GENERAL_SUPERFAP, "Masturbate 250 times.");
			addAchievement("Fapobot", kACHIEVEMENTS.GENERAL_FAPOBOT, "Masturbate 500 times.");

			titleAchievementSection("Bad Ends");
			...
			addAchievement("Because You Can", kACHIEVEMENTS.GENERAL_BAD_ENDER, "Cause or witness 7 Bad Ends to various NPCs.");
