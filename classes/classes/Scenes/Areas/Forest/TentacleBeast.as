package classes.Scenes.Areas.Forest {
	...
	public class TentacleBeast extends Monster {
		...
		private function tentacleEntwine():void {
			...
			if (!player.hasStatusEffect(StatusEffects.TentacleBind)) { //not trapped yet
				//Success
				...
				//Fail
					...
					if (player.hasCock()) //Male/Herm Version:
					...
					else if (player.hasVagina()) //Fem Version:
						outputText("The creature quickly positions a long tentacle with a single sucker over your clitoris. You feel the power of the suction on you, and your body quickly heats up.  Your clit engorges, prompting the beast to latch the sucker onto your " + player.clitDescript() + ".\n");
					else //Genderless Version:
						outputText("The creature quickly positions a long tentacle against your " + player.assholeDescript() + ". It circles your pucker with slow, delicate strokes that bring unexpected warmth to your body.\n");
		...
		override public function defeated(hpVictory:Boolean):void {
			...
			else outputText("The tentacle beast's mass begins quivering and sighing, the tentacles wrapping around each other and feverishly caressing each other.  It seems the beast has given up on fighting.");
