...
package classes.Scenes.Areas.Mountain {
	...
	public class InfestedHellhoundScene extends BaseContent {
		...
		//INTRO – 50% chance split with regular hellhound if worms turned on and over level 2
		public function infestedHellhoundEncounter():void {
			clearOutput();
			outputText(images.showImage("encounter-hellhound-infested"));
		...
		public function infestedHellhoundLossRape():void {
			...
			clearOutput();
			if (player.totalCocks() > 0 && player.hasStatusEffect(StatusEffects.Infested)) { //BOTH INFESTED
				...
				if (player.hasVagina()) outputText(images.showImage("hellhound-infested-herm"));
				else outputText(images.showImage("hellhound-infested-male"));
			...
			else if (!player.hasStatusEffect(StatusEffects.Infested) && player.biggestCockArea() >= 40 && player.hasCock()) { //PLAYER'S COCKS ARE BIG ENOUGH TO BE INFECTED
				if (player.lust >= player.maxLust()) {
					outputText("No amount of shame from the act of submitting to such a beast can overpower the furnace of lust raging in your loins.  ");
					if (player.cor < 33) outputText("In spite of your revulsion ");
					else if (player.cor < 66) outputText("In spite of your better sense ");
				...
				else outputText("Too wounded to stand, you drop down to all fours in order to keep yourself off the ground.   Too late you realize your mistake – the snarling beast is behind you and its razor-shark teeth easily sink into your " + player.armorName + " before tearing it off, exposing your " + player.assDescript() + " and " + player.multiCockDescriptLight() + ".  A cold mountain breeze blows across your now exposed " + player.skin.desc + ", reminding you just how utterly vulnerable you are to the alien lusts of this symbiotic monstrosity.  With a brutal lunge it knocks you off your " + player.feet() + " and onto your back.\n\n");
			...
			else if (player.hasVagina() && player.biggestCockArea() < 40 && player.lowerBody.type != LowerBody.NAGA) { //HAS PUSSY AND NO DICK BIG ENOUGH TO BE INFECTED
				if (player.lust >= player.maxLust()) {
					outputText("No amount of shame from the act of submitting to such a beast can overpower the furnace of lust raging in your loins.  ");
					if (player.cor < 33) outputText("In spite of your revulsion ");
					else if (player.cor < 66) outputText("In spite of your better sense ");
				...
				else outputText("Too wounded to stand, you drop down to all fours in order to keep yourself off the ground.   Too late you realize your mistake – the snarling beast is behind you and its razor-shark teeth easily sink into your " + player.armorName + " before tearing it off, exposing your " + player.assDescript() + " and " + player.vaginaDescript(0) + ".  A cold mountain breeze blows across your now exposed " + player.skin.desc + ", reminding you just how utterly exposed you are to the alien lusts of this symbiotic monstrosity.\n\n");
				...
				//(Status applied – Worm Plugged) – random chance of big lust boost as worms evacuate your body.  When worms leave they take with them up to 5 fertility, to a minimum of 10
			...
			else { //GENDERLESS OR MALE WITH DICK TOO SMALL
				if (player.lust >= player.maxLust()) {
					outputText("No amount of shame from the act of submitting to such a beast can overpower the furnace of lust raging in your loins.  ");
					if (player.cor < 33) outputText("In spite of your revulsion ");
					else if (player.cor < 66) outputText("In spite of your better sense ");
				...
				else outputText("Too wounded to stand, you drop down to on your elbows in order to keep yourself off the ground.   Too late you realize your mistake – the snarling beast is behind you and its razor-shark teeth easily sink into your " + player.armorName + " before tearing it off, exposing your " + player.assDescript() + ".  A cold mountain breeze blows across your now exposed " + player.skin.desc + ", reminding you just how utterly exposed you are to the alien lusts of this symbiotic monstrosity.\n\n");
				outputText("The hell-hound rises up, looking nearly humanoid in shape for a moment before it drops down, planting its paws on your shoulders.  ");
