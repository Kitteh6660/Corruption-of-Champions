package classes.Scenes.Areas.Mountain {
	...
	public class HellHound extends Monster {
		...
		protected function hellhoundScent():void {
			clearOutput();
			outputText(images.showImage("hellhound-scent"));
		...
		override public function defeated(hpVictory:Boolean):void {
			...
			if (player.lust >= 33 && !player.isGenderless()) {
				...
				if (!hpVictory) kGAMECLASS.output.addButton(1, "Lick", game.mountain.hellHoundScene.hellHoundGetsRaped, undefined, undefined, undefined, "Make him use his tongues.");
			}
		...
		override public function won(hpVictory:Boolean, pcCameWorms:Boolean):void {
			...
			else game.mountain.hellHoundScene.hellhoundRapesPlayer();
		}
