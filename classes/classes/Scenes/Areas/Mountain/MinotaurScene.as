		...
		*/
		...
		private function minoUrethralPen():void {
			...
			if (player.statusEffectv1(StatusEffects.Infested) == 5) { //infested version!
				...
				else //max/enhanced cum production (marae's gift: stud, elven bounty, spamming a shitload of succubus dream on debug mode, etc.):
		...
		private function girlRapeAMinotaur():void {
			...
			else if (player.dogScore() >= 4) outputText(images.showImage("minotaur-won-female-canine"));
		...
		private function getOralRapedByMinotaur():void {
			...
			if (player.gender > 1) { //if female or herm
				if (rand(85) > 75) outputText(images.showImage("minotaur-loss-oral"));
				else if (player.cowScore() > 4) outputText(images.showImage("minotaur-loss-oral-female-cow"));
				else outputText(images.showImage("minotaur-loss-oral-female"));
			}
			else if (player.gender == 1) { //if male
				if (rand(85) > 75) outputText(images.showImage("minotaur-loss-oral"));
				else if (player.catScore() > 4) outputText(images.showImage("minotaur-loss-oral-male-cat"));
				else outputText(images.showImage("minotaur-loss-oral-male"));
			}
		...
		public function lootMinoCum():void {
			clearOutput();
