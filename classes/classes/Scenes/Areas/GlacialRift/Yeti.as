package classes.Scenes.Areas.GlacialRift {
	...
	public class Yeti extends Monster {
		...
		public function yetiClawAndPunch():void {
			clearOutput();
			outputText(images.showImage("yeti-attack"));
		...
		public function yetiTackleTumble():void {
			if (player.getEvasionRoll()) { //yeti takes moderate damage
		...
		public function yetiSnowball():void {
			clearOutput();
			outputText(images.showImage("yeti-attack-snowball"));
			if (player.getEvasionRoll())
		...
		public function yetiTease():void {
			clearOutput();
			outputText(images.showImage("yeti-attack-tease"));
			if (rand(player.lib + player.cor) >= 30 && rand(3) > 0) {
				...
				game.dynStats("lust", 20 + rand(10)); //lust increased
			}
