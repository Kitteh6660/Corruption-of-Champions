...
package classes.Scenes.Areas.GlacialRift {
	...
	public class YetiScene extends BaseContent {
		...
		private function getFuckedByYetiDoggyStyle():void {
			...
			outputText("\n");
			outputText(images.showImage("yeti-loss-doggystyle"));
		...
		private function getFuckedByYetiPumpin():void {
			clearOutput();
			outputText("Your body is pinned completely under the large beast, his hand roughly feeling you up through your armor as his monstrous prick slides from the furred sheath to grind over you. All the forceful touching and groping sends shivers down your spine, but despite all that, the warmth of his body pressed against yours is oddly soothing and you find yourself relaxing into it to avoid the cold. WIth a grunt, his large hands cup over your " + player.buttDescript() + " and fondle your ass through your " + player.armorName + ". His forceful touch combined with the heat of his monstrous slick cock grinding over you excites your body, and the scent of the beasts rutting musk edges you even further, ");
			//Gendered PCs
			if (player.hasCock()) outputText("sending blood swelling to your " + player.multiCockDescriptLight() + "");
			if (player.hasCock() && player.hasVagina()) outputText(" as well as ");
			if (player.hasVagina()) outputText("making the lips of your " + player.vaginaDescript(0) + " begin to drool and grow moist");
			outputText(". He grabbing you by the torso and putting you on his belly. With a gasp, you feel his eager touches. With a strong yank of his hands, the yeti exposes your groin, you shiver as it’s briefly left in the cold air.\n\n");
			outputText("A hot slick throbbing length is quickly nestled near your " + player.vaginaDescript(0) + ", humping between your firm mounds as you feel the welcome warmth of the yeti’s cock. You gasp as the naturally slick monster prick drools over your " + player.assholeDescript() + ", smearing the warm preparation fluids all along your taint. The yeti continues to hump you earnestly as his warm furred body lays over yours, and you can’t help but the soft warmth oddly pleasurable despite your limbs being trapped in ice.  ");
			if (player.hasCock()) outputText("Your " + player.multiCockDescriptLight() + " is now fully erect, despite being in the cold air.  ");
			outputText("With a needy grunt the yeti ceases his humping, and when you raise your head, you can see him lining up, one of his hands gripping the hilt of his monstrous length. He presses the pulsing cockhead to your vagina, coaxing a low moan from your lips. The beast gives a guttural moan from his maw, bucking his hips as he starts to move his rod over your pussy. You can only whimper and strain against the white fur holding your limbs in place as the beast slides around your hole.\n\n");
			outputText("The sound of flesh sliding across the flesh bounces off the ice walls of the cavern as the yeti covers your hole once more, his giant huge member pressing up against your pussy totally, each savage thrust making your limbs ache from the strain of your fur holding. Moans slip past your lips despite your discomforts, the furred beast wrapped around you like a heated fur sweater, the brutal slides through your pussy making her hot. You can feel his pre dripping out on your abdomen and leaving warm trails down your hips to his fur.  ");
			if (player.hasCock()) {
				outputText("Some gets onto your fully erect " + player.multiCockDescriptLight() + ", making ");
				if (player.totalCocks() == 1) outputText("it");
				else outputText("them");
			...
			if (player.hasVagina()) outputText("You can feel it pooling along the lips of your mound. ");
			outputText("The yeti’s furred balls slap against you, bludgeoning you with their large size, your cheeks reddening under its abuse.\n");
			outputText(images.showImage("yeti-loss-pumpin"));
			outputText("Your moans grow louder as you reach your limits. ") 
			if (player.hasCock()) outputText("Ropes of cum shoot from your " + player.multiCockDescriptLight() + ", splashing all over yeti's fur and steaming on the cold air. ")
			if (player.hasVagina()) outputText("Your  " + player.vaginaDescript(0) + " is drenched in your sex, leaving your buttocks slick in your pleasure and dripping down to steam on the white pelt under you. ")
			player.cuntChange(18, true);
			outputText("Suddenly with a low snarl the yeti rams into your " + player.vaginaDescript(0) + ": hilted in you as much as he can manage, he begins to pump you full of his cold resistant spunk. It warms your womb and lower body in ways that make you groan, his baseball sized balls filling you well past your limits as it flood your inner confines, spilling out to drenching your groin. Soon there is a large heated pool on his belly. With a wet pop the yeti pulls his spent cock from your over stuffed hole. Without any further ceremony the beast’s prick returns to it’s sheath and the yeti leaves out the way he came in, leaving you a trapped, helpless fuckhole to be used later.\n\n")
			outputText("You stand up on the cold cavernous ground. ")
			outputText("Collecting your things, you notice you lost some gems during the struggle, but you ignore them since you are eager to leave the cavern. Taking the exit the yeti had used to wander back out into the rift, you begin your long walk to camp.. but as you trek through the frigid fields of the glacial rift, you notice your groin stays hot despite the cold. Perhaps it’s a special quality of the yeti’s cum?")
		...
		private function getFuckedByYetiFacial():void {
			clearOutput();
			outputText(images.showImage("yeti-loss-facial"));
		...
		public function winAgainstYeti():void {
			clearOutput();
			outputText(images.showImage("yeti-victory"));
			...
			if (player.lust >= 33){
				if (player.hasCock()) addButton(0, "Buttfuck", fuckYetiInTheAss);
				if (player.hasVagina()) addButton(1, "RideHisCock", rideYetisCock);
			}
		...
		private function fuckYetiInTheAss():void {
			...
			outputText(images.showImage("yeti-assfuck"));
		...
		private function rideYetisCock():void {
			...
			player.cuntChange(18, true);
			outputText("\n");
			outputText(images.showImage("yeti-vagride"));
