			...
			switch(select) {
				...
				case 6:
					...
					outputText("You coyly open your " + player.armorName + " and giggle, \"<i>Is this, like, what you wanted to see?</i>\"  ");
						...
						else if (player.findPerk(PerkLib.BimboBody) >= 0 && !player.hasStatusEffect(StatusEffects.PerksDisabled)) outputText("bimbo ");
				...
				case 8:
					...
					if (player.findPerk(PerkLib.BroBrains) >= 0 && !player.hasStatusEffect(StatusEffects.PerksDisabled)) outputText("Damn, " + monster.a + monster.short + " has got to love this!");
				...
				case 9:
					...
					if (player.findPerk(PerkLib.BroBrains) >= 0 && !player.hasStatusEffect(StatusEffects.PerksDisabled)) outputText(monster.capitalA + monster.short + " can't resist such a heroic pose!");
				...
				case 10:
					...
					if (player.findPerk(PerkLib.BroBrains) >= 0 && !player.hasStatusEffect(StatusEffects.PerksDisabled)) outputText("No way could " + monster.pronoun1 + " resist your huge cock!");
				...
				case 11:
					if (silly() && rand(2) == 0) outputText("You strike a herculean pose and flex, whispering, \"<i>Do you even lift?</i>\" to " + monster.a + monster.short + ".");
						...
						if (player.findPerk(PerkLib.BroBrains) >= 0 && !player.hasStatusEffect(StatusEffects.PerksDisabled)) outputText("Bitches love a cum-leaking cock.");
