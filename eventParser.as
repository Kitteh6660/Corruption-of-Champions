...
public function goNext(time:Number, needNext:Boolean):Boolean  {
	...
	if (flags[kFLAGS.SCARRED_BLADE_STATUS] == 1 && player.cor >= (70 - player.corruptionTolerance())) {
	...
	if (player.armorName == "bimbo skirt" && player.cor >= (10 - player.corruptionTolerance()) && player.upperGarment != UndergarmentLib.NOTHING) {
	...
	if (player.armorName == "bimbo skirt" && player.cor >= (10 - player.corruptionTolerance()) && player.lowerGarment != UndergarmentLib.NOTHING) {
